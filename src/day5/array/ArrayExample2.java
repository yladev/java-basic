...
public class ArrayExample2 {
    public static void main(String[] args) {
        ...
        String Students[][] = {
                ...
                {"EmCia", "Harry", "May", "Ingyin", "ONu"},
                {"Jason", "Tet", "Zed", "Rena", "Phue",},
                {"Luca", "Luna", "Niko", "Victor", "Max",},
                {"Sai", "Martin", "Sweety", "Rio", "Sweet",},
        };
        for (int o = 0; o < Students.length; o ++) {
            for (int l = 0; l < Students[o].length; l ++) {
                System.out.println("that is output =>" + Students[o][l]);
            }
        }
    }
}
